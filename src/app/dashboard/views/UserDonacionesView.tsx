...
const UserDonacionesView = () => {
  ...
  useEffect(() => {
    // Solo hacemos la petición cuando userData está disponible (es decir, en el cliente)
    ...
    // Solo llamamos a fetchDonaciones cuando tenemos userData
    if (userData?.user?.idUser) {
      fetchDonaciones();
    }
  }, [userData]); // Dependencia de userData para asegurarnos de que solo se llame cuando esté disponible
