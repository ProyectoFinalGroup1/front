  ...
  return (
    <div className="min-h-screen bg-gradient-to-b py-10 px-4">
      <div className="max-w-5xl mx-auto m-16">
        ...
        {inhumado.publicaciones && inhumado.publicaciones.length > 0 && (
            ...
            <div className="p-6 overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {inhumado.publicaciones.map((pub) => (
                      ...
                      <td className="px-6 py-4">
                        ...
                        >
                          {pub.aprobada ? (
                            ...
                            <>
                              <svg className="h-3 w-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 102 0V6zm0 6a1 1 0 10-2 0 1 1 0 102 0z" clipRule="evenodd" />
                              </svg>
                              Pendiente
                            </>
                          )}
