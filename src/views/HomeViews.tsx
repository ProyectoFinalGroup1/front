...
export default function Home() {
  return (
    <div className="relative min-h-screen flex flex-col">
      ...
      >
        <div className="w-full max-w-[90%] md:max-w-3xl bg-white bg-opacity-30 shadow-md rounded-xl p-6 backdrop-blur-sm">
          ...
          <p className="block text-xl md:text-2xl font-semibold text-green mt-4">
      ...
      <div 
        className="relative px-6 py-10 text-center min-h-screen flex items-center justify-center"
        style={{ 
